  ...
  !(function () {
    ...
    (n = {
      ...
      compareVersions: function (t, e) {
        ...
        for (r = 0; r < n.length; r++) {
          if (((i = parseInt(n[r])), (o = parseInt(a[r] || 0)), o < i))
            return !1;
          if (o > i) return !0;
        }
        return !0;
    ...
    n.extend(e.Control.prototype, {
      ...
      handleClick: function (t) {
        ...
        if (
          ...
          (this.pending = 0),
          (i = a.selector
            ? n.closestParent(t.target, a.selector, !0, a.bound[0].dom.document)
            : a.el),
          !i)
        )
    ...
    n.extend(e.Mixer.prototype, {
      ...
      initControls: function () {
        ...
        for (l = 0; (n = e.controlDefinitions[l]); l++)
          if (t.config.controls.live || n.live) {
            ...
            for (a = o.querySelectorAll(n.selector), c = 0; (i = a[c]); c++)
        ...
        for (
          e.callActions("beforeSetInter", arguments),
            e.config.animation.clampHeight &&
              ((e.dom.parent.style.height = t.startHeight),
      ...
      cleanUp: function (t) {
        ...
        if (
          (t.willSort && (a.printSort(!1, t), (a.targets = t.newOrder)),
          (a.dom.parent.style[e.features.transitionProp] =
      ...
      diffDatasets: function (t) {
        var a = this,
          ...
          d = 0;
        for (
          a.callActions("beforeDiffDatasets", arguments), d = 0;
          (r = t.newDataset[d]);
          d++
        ) {
          if (
            "undefined" == typeof (h = r[a.config.data.uidKey]) ||
            h.toString().length < 1
          )
            throw new TypeError(
          ...
          (f[h] = !0),
            (s = a.cache[h]) instanceof e.Target
              ? (a.config.data.dirtyCheck &&
                  !n.deepEquals(r, s.data) &&
                  ((l = a.renderTarget(r)),
                  (s.data = r),
                  a.dom.parent.replaceChild(l, s.dom.el),
                  (s.dom.el = l)),
                (l = s.dom.el))
              : ((l = l = a.renderTarget(r)),
                (s = new e.Target()),
                s.init(l, a, r)),
            s.isInDom
              ? ((u = s.dom.el.nextElementSibling),
                o.push(h),
                c &&
                  (c.lastElementChild &&
                    c.appendChild(a.dom.document.createTextNode(" ")),
                  a.dom.parent.insertBefore(c, s.dom.el),
                  (c = null)))
              : (c || (c = a.dom.document.createDocumentFragment()),
                c.lastElementChild &&
                  c.appendChild(a.dom.document.createTextNode(" ")),
                c.appendChild(l),
                (s.isInDom = !0),
        ...
        for (
          c &&
            ((u = u || a.config.layout.siblingAfter),
          ...
          (h = r[a.config.data.uidKey]),
            (s = a.cache[h]),
            t.show.indexOf(s) < 0
              ? (t.hide.push(s), t.toHide.push(s), t.toRemove.push(s))
              : i.push(h);
      ...
      renderTarget: function (t) {
        var n = this,
          ...
          r = "";
        if (
          (n.callActions("beforeRenderTarget", arguments),
